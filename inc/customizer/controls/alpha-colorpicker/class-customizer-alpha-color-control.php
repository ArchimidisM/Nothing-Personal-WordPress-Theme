...
define( 'NOTHING_PERSONAL_ALPHA_VERSION', '1.0.0' );

/**
 * Class Nothing_Personal_Alpha_Color_Control
 */
class Nothing_Personal_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script(
			...
			get_template_directory_uri() . '/inc/customizer/controls/alpha-colorpicker/js/alpha-color-picker.js',
			array( 'jquery', 'wp-color-picker' ),
			NOTHING_PERSONAL_ALPHA_VERSION,
			true
		);
		wp_enqueue_style(
			'customizer-alpha-color-picker',
			get_template_directory_uri() . '/inc/customizer/controls/alpha-colorpicker/css/alpha-color-picker.css',
